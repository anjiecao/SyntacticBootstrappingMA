...
this_moderator_estimate <- model$b
this_moderator_SE <- synchronicity_model$se
this_moderator_estimate.cil <- model$ci.lb
this_moderator_estimate.cih <- model$ci.ub
this_moderator_z <- model$zval
this_moderator_p <- model$pval
