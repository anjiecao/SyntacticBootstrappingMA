...
```{r}
# currently special treatment because it has three levels 
...
colnames(synchronicity_info) <- c("moderator", "this_moderator_estimate", "this_moderator_SE", "this_moderator_estimate.cil", "this_moderator_estimate.cih", "this_moderator_z", "this_moderator_p")
#synchronicity_info
```

<!-- revision needed!!! it has three levels!! -->
