...
We calculated the Cohen's d effect size for each experimental condition. Because we only included studies that used a two alternative forced-choice test method, we compare[*N* = `r num_has_raw`; e.g. @arunachalam2013out; @arunachalam2019semantic; @naigles2011abstractness; @jyotishi; @naiglesUnpuba; @naiglesUnpubb], most papers did not. In order to calculate a consistent effect size measure across all condition, we used chance level as a baseline for calculating effect size for all conditions (see SI for comparision of effect sizes using reported baseline versus chance). 
