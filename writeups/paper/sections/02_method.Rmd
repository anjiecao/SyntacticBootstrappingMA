...
Our final sample included  `r n_papers` individual papers, corresponding to `r n_effect_sizes` individual effect sizes and `r different_infants` unique infants (Mean age: `r mean_age_day` days). <!-- convert this to a meaninful unit - months; days --->
