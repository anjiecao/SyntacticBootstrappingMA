...
Using the raw coded data, we calculated an effect size estimate for each condition as Cohen's *d*.  Cohen's *d* was calculated as the difference between the proportion correct responses and chance (.5), divided by a pooled estimate of variance (see SI, Sec. 1 for example calculation). Due to children's baseline preference for causative action scene, our analytic method leads to some negative effect sizes, especially for intransitive conditions where the correct responses were the non-causative action scene. This analytical decision was made to standardize the effect size estimate across all conditions in our sample. In most conditions, the original analysese compared the proportion of looking time at the causative action between transitive conditions and intransitive conditions. Note that compared to the latter method, our calculation offered a more conservative estimate of the effect sizes (See SI, Sec. 2 for direct comparison between two methods).    
