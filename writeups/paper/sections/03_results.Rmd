...
label_position <- tibble(
  ...
  label_x = c(tidy_models_with_age_younger$mean_age_in_month[1:4]+1.5,
            tidy_models_with_age_younger$mean_age_in_month[5]-1.5), 
