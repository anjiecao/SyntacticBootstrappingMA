...
```{r label = "forest", fig.pos = "!t", fig.cap = "Each row in the forrest plot represents an individual effect size. The black circles correspond to individual conditions using transitive sentences. The black triangles correspond to individual conditions using intransitive sentences. The size of the circles and triangles indicate their weights, and the horizontal error bars show the 95% confidence intervals. The red diamond at the bottom is the meta-analytic effect size aggregated across all conditions included in the literature.",fig.width = 5, fig.height = 7.5}
