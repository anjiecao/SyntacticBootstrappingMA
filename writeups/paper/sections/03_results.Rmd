...
<!-- TO DO -->
In order to learn words, children must figure out the mapping relationships between the words and their references. Previous research has proposed numerous biases and learning strategies by which children can solve the mapping problem. Here we relate the syntactic bootstrapping effect to other word learning stratgies. We found its effect size is relatively small compared to the other phenomena in children under 36 months of age. [the other goes into the caption?]
