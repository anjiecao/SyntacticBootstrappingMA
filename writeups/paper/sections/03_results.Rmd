...
```{r label = "forest", fig.pos = "!t", fig.cap = "Forest plot showing individual effect size included in the meta-analysis. Black circles and triangles correspond to individual conditions with transitive sentences and intransitive sentences, respectively. Point size corresponds to study weights, and  horizontal error bars show  95% confidence intervals. The red diamond at the bottom is the meta-analytic effect size aggregated across all conditions included in the literature. The label on each row contains the short citation of the paper, the experiment number, and the different conditions within the same experiment.",fig.width = 5, fig.height = 7.5}
