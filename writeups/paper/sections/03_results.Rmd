...
We first evaluated the evidence for publication bias in order to determine the evidential value of the literature. Publication bias refers to the tendency to selectively publish positive findings. This practice inflates meta-analytic estimates of effect size and threatens the evidential value of the literature. We present two analyses of publication bias: a classic funnel plot analysis, and a sensitivity analysis that assumes a more plausible model of publication bias. 
