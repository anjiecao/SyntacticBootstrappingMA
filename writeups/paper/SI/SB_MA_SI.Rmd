...
# Additional Models: Methodological Moderators with Theoretical Moderators {.tabset}
## With age
```{r}
...
age_print_table %>% 
  kable() %>% 
  kable_styling(font_size = 12) %>% 
  row_spec(which(age_print_table$Parameter == "Mean age"),bold = T, color = "white", background = "cornflowerblue")
...
vocab_print_table %>% 
  kable() %>% 
  kable_styling(font_size = 12) %>% 
  row_spec(which(vocab_print_table$Parameter == "Median productive vocabulary size"),bold = T, color = "white", background = "cornflowerblue")
...
sentence_structure_print_table %>% 
  kable() %>% 
  kable_styling(font_size = 12) %>% 
  row_spec(which(sentence_structure_print_table$Parameter == "Predicate type (Transitive / Intransitive)"),bold = T, color = "white", background = "cornflowerblue")
...
argument_type_print%>% 
  kable() %>% 
  kable_styling(font_size = 12) %>% 
  row_spec(which(argument_type_print$Parameter == "Noun phrase type (Pronoun / Nouns)"),bold = T, color = "white", background = "cornflowerblue")
```




# Additional Models: exploratory moderators {.tabset}
