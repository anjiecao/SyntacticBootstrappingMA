...
This document was created from an R markdown file. The repository for the project can be found at https://github.com/anjiecao/SyntacticBootstrappingMA. The data reported in the paper can be explored interactively at the [Metalab website](http://metalab.stanford.edu/).
