...
## Agent argument type for intransitive sentence 
## Stimuli Modality (Video or Animation)
## Stimuli actors (Person or Non-person)
## Type of transitive event (Direct causal action or Indirect causal action)
## Type of intransitive event (Single-actor or parallel actions)
## Number of train-test pair 
## Number of test trial per pair 
## Number of video repetitions 
 
[Creat a predictor plots? table? what about interaction between them?]
