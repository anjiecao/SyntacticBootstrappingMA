...
Raw data from the paper (pg 622) Table 1 
The values are Mean looking time in seconds (Standard Errors)
```{r}
tibble(
...
Then we calculate Cohen's d as follows (the implemetation of the script can be found at XXX)
...
Then we calculate the variance of Cohen's d and the Confidence Intervals as following: 
