...
affiliation:
  ...
  - id            : "1"
    institution   : "XXXXXXXXXXXXXXXXXXXXX"
  - id            : "2"
    institution   : "XXXXXXXXXXXXXXXXXXXXX"
author_note: "Data Availability Statement: All data and analysis scripts are available at XXXXXXXXXXXXXXXXXXXXX."
...
# Introduction
```{r child = "sections_blinded/01_intro.Rmd"}
```

# Method
```{r child = "sections_blinded/02_method.Rmd"}
```

# Results
```{r child = "sections_blinded/03_results.Rmd"}
```

# General Discussion
```{r child = "sections_blinded/04_discussion.Rmd"}
```
