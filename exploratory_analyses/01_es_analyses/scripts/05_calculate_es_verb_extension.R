...
INPATH <- here("data/raw/verbextension_raw_data.csv")
OUTPATH <- here("data/processed/verbextension_tidy_data.csv")
...
# read in raw data
ma_data <- read_csv(INPATH, col_types = "ccccccccccccccdddddddddccdddcccccccccccccddddccdc")
